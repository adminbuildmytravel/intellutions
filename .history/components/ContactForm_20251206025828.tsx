            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={isSubmitting}
                  rows={5}
                  className="w-full px-4 py-3 rounded-lg bg-zinc- text-white placeholder:text-purple-200 focus:ring-2 focus:ring-primary focus:outline-none transition-all resize-none disabled:opacity-50 disabled:cursor-not-allowed"
