            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  disabled={isSubmitting}
                  className="w-full px-4 py-3 rounded-lg bg-z text-white placeholder:text-purple-200 focus:ring-2 focus:ring-primary focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
